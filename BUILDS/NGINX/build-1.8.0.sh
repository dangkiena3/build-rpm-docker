...
./configure --prefix=/usr/local/nginx --sbin-path=/usr/local/nginx/sbin/nginx --conf-path=/usr/local/nginx/conf/nginx.conf --http-log-path=/var/log/nginx/access.log --error-log-path=/var/log/nginx/error.log --without-mail_pop3_module --without-mail_imap_module --without-mail_smtp_module --without-http_split_clients_module --without-http_uwsgi_module --without-http_scgi_module --with-openssl=../openssl-1.0.2k --with-http_realip_module --with-http_secure_link_module --with-http_dav_module --with-http_stub_status_module --with-pcre=../pcre-8.40 --with-http_geoip_module --with-zlib=../zlib-1.2.11 --with-http_gzip_static_module --with-debug --with-file-aio --with-http_mp4_module --with-http_addition_module --with-http_perl_module --with-ld-opt="-Wl,-E" --add-module=../ngx_http_redis --with-http_ssl_module --with-http_stub_status_module --add-module=../nginx-rtmp-module --add-module=../echo-nginx-module --add-module=../ngx_http_log_request_speed
